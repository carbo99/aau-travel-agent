"""
Runs a batch of interactions against the agent and saves the metrics to a CSV.
Covers: simple prompts, tool-calling prompts and memory-based follow-ups.

Usage:
    python benchmark/run_benchmark.py
The API must be running (uvicorn app.main:app) and Ollama must be up.
"""
import csv
import time
import requests
